...
public class Radiologist extends User {
	...
	public Radiologist() {
		super();
		this.title = Title.RADIOLOGIST;
		this.isActive = true;
	}

	public Radiologist(String username, String password, String firstName, String lastName, String email, String phoneNumber,
			Role role) {
	...
	public String toString() {
		return "Radiologist [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", password="
